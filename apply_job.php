...
$query=mysqli_query($conn,"insert into job_apply(first_name,last_name,dob,file,filea,fileb,id_job,job_seeker,mobile_number)values('$first_name','$last_name','$dob','$file','$filea','$fileb','$id_job','$job_seeker','$number')");
if($query){ ?>
