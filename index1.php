...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Dream Jobs</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            if(isset( $_SESSION['email'])==true){ ?>
	          ...
	          <li class="nav-item cta mr-md-2"><a href="my_profile.php" class="nav-link"><?php echo  $_SESSION['email']; ?></a></li>
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  <div class="mr-3"><span class="icon-layers"></span> <?php echo $row['company']; ?><a href="#"></a></div>
                  <div><span class="icon-my_location"></span><?php echo $row['country'] ?>,<?php echo $row['state']; ?>,<?php echo $row['city']; ?> <span></span></div>
                </div>
              </div>
    ...
    <!-- <section class="ftco-section ftco-counter">
        ...
        <div class="row">
        	<div class="col-md-3 ftco-animate">
        		<ul class="category">
        			<li><a href="#">Web Development <span class="number" data-number="5">0</span></a></li>
        			<li><a href="#">App develepoment <span class="number" data-number="5">0</span></a></li>
        			<li><a href="#">Journalism <span class="number" data-number="5">0</span></a></li>
        			<li><a href="#">Sale <span class="number" data-number="5">0</span></a></li>
        		</ul>
        	</div>
...
fprintf($fp,"%d",$hitts[0]);
fclose($fp);
// print"The total no of views:.$hitts[0]";
?> -->